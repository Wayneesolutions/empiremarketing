...
const Footer = () => {
  return (
    <footer className="bg-[#014631] text-white/80">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading font-semibold text-white mb-6 text-sm tracking-wider uppercase">Quick Links</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="font-heading font-semibold text-white mb-6 text-sm tracking-wider uppercase">Services</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-heading font-semibold text-white mb-6 text-sm tracking-wider uppercase">Contact Us</h4>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-white/40">© 2026 Empire Stairs & Kitchens. All rights reserved.</p>
